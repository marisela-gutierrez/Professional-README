...
function renderLicenseBadge(license) {
  switch (license) {
    ...
    case "Boost Software License 1.0":
      ...
      return "[![License: Boost Software License 1.0](https://img.shields.io/badge/License-BSL1.0-lightblue.svg)](https://www.boost.org/LICENSE_1_0.txt)";
    case "The Unlicense":
...
function generateMarkdown(data) {
  ...
  * [License](#license)
  ...
  ${data.test}
  ## Questions
  Please visit my [GitHub page](https://github.com/${data.github}).<br />${data.github}
